...
void Lab2::Init()
{
    ...
    for (int i = 0; i < 40; ++i)
    {
        ...
        lightInfo.position = Rand01() * glm::vec3(20.0f, 3.0f, 20.0f) + glm::vec3(-10.0f, 0.0f, -10.0f);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    for (auto& l : lights)
    {
        ...
        rotationRadians = 6.0f * TO_RADIANS * deltaTimeSeconds;
    ...
    // Lighting pass
    {
        ...
        for (auto& lightInfo : lights)
        {
            // TODO(student): Set the shader uniforms 'light_position', 'light_color' and 'light_radius'
             // see the shader implementation in core/gpu/shader.h
